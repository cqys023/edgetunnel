...
// 建议修改为自己的 UUID
let userID = 'bca6b240-8716-485f-b210-e32a9b34b693';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "94.140.0.207"

// 用于 CF 网站的代理 IP
const proxyIPs = ["47.243.169.90"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
